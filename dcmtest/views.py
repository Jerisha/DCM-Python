    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if report_identifier == "SearchViewExtract":
                ...
                if "source" in req['Data'][0]: 
                    source = req['Data'][0]['source']
                ...
                returnedData = getmethods.search_audit(file_name,file_name_operator, file_type, source, destination, start, end)  
