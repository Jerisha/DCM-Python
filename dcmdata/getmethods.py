...
def search_audit(file_name,file_name_operator, file_type, number_type, destination, start, end):
	audit_data = {}
	audit_count = 0
	return_response = {}
	...
	try:
		...
		if number_type !="":
			get_methods_error.write("number_type")
			where_con=where_con+" and upper(t.number_type) = '"+str(number_type.upper())+"'"
			get_methods_error.write(where_con)
